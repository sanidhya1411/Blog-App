...
const EditPost = () => {
  ...
  useEffect(() => {
    const getPost = async () => {
      try {
        const response = await axios.get(`https://blog-backend-six-drab.vercel.app/api/posts/${id}`)
  ...
  const editPost = async (e) => {
    ...
    try {
      const response = await axios.patch(`https://blog-backend-six-drab.vercel.app/api/posts/${id}`, postData, { withCredentials: true, headers: { Authorization: `Bearer ${token}` } })
